...
import utils.modeling.noise_schedule
import utils.modeling.ema
import utils.modeling.samplers
import models
import logging
...
class Diffusion(L.LightningModule):
  def __init__(
    ...
    self.noise = utils.modeling.noise_schedule.get_noise(self.config,
                                          dtype=self.dtype)
    if self.config.training.ema > 0:
      self.ema = utils.modeling.ema.ExponentialMovingAverage(
